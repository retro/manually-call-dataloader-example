...
var len__31496__auto___44986 = arguments.length;
var i__31497__auto___44987 = (0);
while(true){
if((i__31497__auto___44987 < len__31496__auto___44986)){
args__31503__auto__.push((arguments[i__31497__auto___44987]));

var G__44988 = (i__31497__auto___44987 + (1));
i__31497__auto___44987 = G__44988;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31504__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq44984){
var G__44985 = cljs.core.first.call(null,seq44984);
var seq44984__$1 = cljs.core.next.call(null,seq44984);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__44985,seq44984__$1);
});
...
return (p1__44989_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1515669762047
