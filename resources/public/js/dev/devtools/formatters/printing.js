...
var len__31496__auto___44995 = arguments.length;
var i__31497__auto___44996 = (0);
while(true){
if((i__31497__auto___44996 < len__31496__auto___44995)){
args__31503__auto__.push((arguments[i__31497__auto___44996]));

var G__44997 = (i__31497__auto___44996 + (1));
i__31497__auto___44996 = G__44997;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__31504__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq44992){
var G__44993 = cljs.core.first.call(null,seq44992);
var seq44992__$1 = cljs.core.next.call(null,seq44992);
var G__44994 = cljs.core.first.call(null,seq44992__$1);
var seq44992__$2 = cljs.core.next.call(null,seq44992__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__44993,G__44994,seq44992__$2);
});
...
if(cljs.core.truth_((function (){var or__30217__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__30888__auto__,writer__30889__auto__,opt__30890__auto__){
return cljs.core._write.call(null,writer__30889__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__30205__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__30205__auto__){
var or__30217__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__30217__auto__)){
return or__30217__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__44998_SHARP_){
return !((cljs.core.meta.call(null,p1__44998_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__44999__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__30217__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e45003){var e__43135__auto__ = e45003;
return false;
}})();
if(cljs.core.truth_(or__30217__auto__)){
return or__30217__auto__;
...
}catch (e45005){var e__43135__auto__ = e45005;
return false;
}}
})())){
...
var _STAR_current_state_STAR_45007 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__45008 = opts;
...
var markup_db = cljs.core.get.call(null,map__45008__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_45007;
}});
...
;
var temp__5455__auto___45012 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___45012)){
var managed_print_level_45013 = temp__5455__auto___45012;
var _STAR_print_level_STAR_45011_45014 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_45013;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_45011_45014,managed_print_level_45013,temp__5455__auto___45012,writer,opts,job_fn){
return (function (p1__45010_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__45010_SHARP_,null);
});})(_STAR_print_level_STAR_45011_45014,managed_print_level_45013,temp__5455__auto___45012,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_45011_45014;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1515669762119
