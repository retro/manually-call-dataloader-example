...
var or__30217__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj39348 = {"detail":data};
return obj39348;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__30205__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__30205__auto__)){
var and__30205__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__39355 = cljs.core._EQ_;
var expr__39356 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__39355.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__39356))){
return ((function (pred__39355,expr__39356){
return (function (p1__39349_SHARP_){
return console.warn(p1__39349_SHARP_);
});
;})(pred__39355,expr__39356))
} else {
if(cljs.core.truth_(pred__39355.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__39356))){
return ((function (pred__39355,expr__39356){
return (function (p1__39350_SHARP_){
return console.debug(p1__39350_SHARP_);
});
;})(pred__39355,expr__39356))
} else {
if(cljs.core.truth_(pred__39355.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__39356))){
return ((function (pred__39355,expr__39356){
return (function (p1__39351_SHARP_){
return console.error(p1__39351_SHARP_);
});
;})(pred__39355,expr__39356))
} else {
return ((function (pred__39355,expr__39356){
return (function (p1__39352_SHARP_){
return console.log(p1__39352_SHARP_);
});
;})(pred__39355,expr__39356))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__39359){
...
var eval_fn = cljs.core.get.call(null,map__39360__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__39362_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__39364,(0),null);
var v = cljs.core.nth.call(null,vec__39364,(1),null);
...
if(cljs.core.truth_((function (){var and__30205__auto__ = typeof localStorage !== 'undefined';
...
}catch (e39369){if((e39369 instanceof Error)){
var e = e39369;
return not_found;
} else {
throw e39369;
...
//# sourceMappingURL=utils.js.map?rel=1515669755680
